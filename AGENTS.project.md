...
Navigation: Dashboard, Klar-o-Mat, Fälle, Lohklar KI, Steckbriefe.
...
| **D** | Lohklar KI | `src/components/ki/*`, `src/routes/app/ki.tsx`, `src/routes/app/lohlotse.tsx` (Redirect), `src/lib/domain/ki.ts`, `src/lib/server/ki.ts`, `migrations/0009_ki_messages.sql`, `migrations/0010_drop_lohlotse.sql` |
